...
export default function PatientsModule() {
  const dummyPatients = [
    { id: 1, name: "Prathyusha", age: 24, lastVisit: "15/05/2026", status: "Active Treatment", risk: "High", image: "P" },
    { id: 2, name: "John Doe", age: 34, lastVisit: "10/05/2026", status: "Routine Checkup", risk: "Low", image: "J" },
    { id: 3, name: "Sarah Smith", age: 28, lastVisit: "02/05/2026", status: "Pending Review", risk: "Medium", image: "S" },
    { id: 4, name: "Michael Brown", age: 45, lastVisit: "28/04/2026", status: "Completed", risk: "Low", image: "M" },
    { id: 5, name: "Emily Davis", age: 31, lastVisit: "20/04/2026", status: "Active Treatment", risk: "High", image: "E" },
  ];
    ...
    <div className="p-8 h-full bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-white font-sans">
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-slate-500 dark:text-slate-400 mt-1">View, search, and manage your patient directory.</p>
        </div>
                ...
                <tr key={patient.id} className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                  ...
                  <td className="px-6 py-4">
                    <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${
                      ...
                      patient.risk === 'Medium' ? 'bg-yellow-100 text-yellow-800 dark:bg-yellow-900/30 dark:text-yellow-400' :
