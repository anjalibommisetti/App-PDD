...
const alerts = [
  { icon: "shield", title: "High risk detected", desc: "Your latest score (78%) requires attention.", time: "2h ago", tone: "alert" },
  { icon: "clock", title: "Follow-up reminder", desc: "Schedule a dental visit within 14 days.", time: "Today", tone: "warning" },
  { icon: "bell", title: "Brushing reminder", desc: "Don't forget your evening brush!", time: "8:00 PM", tone: "mint" },
  { icon: "check-circle", title: "Health improving", desc: "You've maintained your streak for 5 days.", time: "Yesterday", tone: "success" },
  { icon: "alert-triangle", title: "Low health compliance", desc: "Recommendations from last visit not followed.", time: "3d ago", tone: "warning" },
];
