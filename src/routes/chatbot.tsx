  ...
  const handleSend = () => {
    ...
    setTimeout(() => {
      ...
      if (lower.includes("pain") || lower.includes("hurt")) {
        reply = "I'm sorry to hear you're in pain. Tooth pain can indicate an infection or cavity. I recommend booking an appointment with a dentist immediately. You can use the 'Book Visit' tool on your dashboard.";
      } else if (lower.includes("brush") || lower.includes("floss")) {
        reply = "You should brush your teeth at least twice a day for two minutes each time, using fluoride toothpaste. Don't forget to floss once a day to remove plaque between your teeth!";
...
const styles = StyleSheet.create({
  ...
  botAvatar: {
    width: 28, height: 28, borderRadius: 14, backgroundColor: "#157A6E",
  ...
  inputContainer: { 
    ...
    borderTopWidth: 1, borderTopColor: "#E2E8F0", alignItems: "center", gap: 12
  },
  input: {
    flex: 1, backgroundColor: "#F1F5F9", borderRadius: 24, paddingHorizontal: 16, paddingVertical: 12,
    fontSize: 15, color: "#0F172A", outlineStyle: "none"
  } as any,
  sendButton: {
    width: 44, height: 44, borderRadius: 22, backgroundColor: "#157A6E",
    alignItems: "center", justifyContent: "center", paddingRight: 2
  },
